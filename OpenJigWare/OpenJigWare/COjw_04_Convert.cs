        ...
        public class CConvert
        {
            ...
            */
            ...
            public static int HexStrToInt(String strData)
            {
                try
                {
                    return int.Parse(S_StrTrim(strData), System.Globalization.NumberStyles.HexNumber);
                }
                catch
                {
                    return 0;
            ...
            public static long HexStrToLong(String strData)
            {
                try
                {
                    return long.Parse(S_StrTrim(strData), System.Globalization.NumberStyles.HexNumber);
                }
                catch
                {
                    return 0;
            ...
            public static Byte HexStrToByte(String strData)
            {
                try
                {
                    return Byte.Parse(S_StrTrim(strData), System.Globalization.NumberStyles.HexNumber);
                }
                catch
                {
                    return 0;
