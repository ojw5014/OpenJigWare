...
namespace OpenJigWare.Docking
{
    public partial class frmDesigner : Form
    {
        ...
        private void frmDesigner_Load(object sender, EventArgs e)
        {
            ...
            m_fTab_W = (float)this.tcControl.Width;
            m_fTab_H = (float)this.tcControl.Height;
        ...
        private void frmDesigner_Resize(object sender, EventArgs e)
        {
            if (m_nInit != 0)
            {
                ...
                tcControl.Width = (int)Math.Round(m_fTab_W * fRatio_W);
                tcControl.Height = (int)Math.Round(m_fTab_H * fRatio_H);
